...
- [ ] **Dashboard chủ shop** (`/dashboard`): hiện chỉ có khung trống (placeholder, mới thêm nút "Xem storefront →") — quản lý sản phẩm, đơn hàng, coupon, nhân viên, báo cáo doanh thu (chart), trang billing/nâng cấp gói chưa làm. **Định hướng thiết kế**: theo phong cách KiotViet thật sự (sidebar nav, bảng dữ liệu, KPI card) khi làm nội dung thật — không phải style card-giữa-trang xám như trang login
