...
import com.ut.edu.backend.model.OrderItem;
import com.ut.edu.backend.model.Product;
import com.ut.edu.backend.repository.CartItemRepository;
import com.ut.edu.backend.repository.CartRepository;
import com.ut.edu.backend.repository.OrderRepository;
import com.ut.edu.backend.repository.PaymentRepository;
import com.ut.edu.backend.repository.ProductRepository;
import com.ut.edu.backend.security.AuthorizationService;
import com.ut.edu.backend.service.impl.PayPalService;
import com.ut.edu.backend.service.impl.RedisCartCacheService;
...
public class PaymentController {
    ...
    public ResponseEntity<?> createPayment(@RequestBody Map<String, Long> request) {
        try {
            ...
            com.ut.edu.backend.model.Payment payment = com.ut.edu.backend.model.Payment.builder()
                    .order(order)
    ...
    public ResponseEntity<?> executePayment(@RequestBody Map<String, String> request) {
        try {
            ...
            // Find payment record
            com.ut.edu.backend.model.Payment payment = paymentRepository.findByPaypalOrderId(paypalPaymentId)
    ...
    public ResponseEntity<?> getPayment(@PathVariable Long paymentId) {
        try {
            ...
            com.ut.edu.backend.model.Payment payment = paymentRepository.findById(paymentId)
    ...
    public ResponseEntity<?> getPaymentByOrderId(@PathVariable Long orderId) {
        try {
            ...
            com.ut.edu.backend.model.Payment payment = paymentRepository.findByOrderId(orderId)
                    .orElse(null);
     ...
     */
    private Map<String, Object> buildPaymentResponse(com.ut.edu.backend.model.Payment payment) {
    ...
    private void handlePaymentCompleted(Map<String, Object> webhookData) {
        try {
            ...
            com.ut.edu.backend.model.Payment payment = paymentRepository
     ...
     */
    private String buildOrderDetailsForEmail(Order order, com.ut.edu.backend.model.Payment payment) {
     ...
     */
    private String buildRefundDetailsForEmail(Order order, com.ut.edu.backend.model.Payment payment, BigDecimal refundAmount) {
        StringBuilder sb = new StringBuilder();
