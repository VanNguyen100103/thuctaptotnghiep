...
public class GlobalExceptionHandler {
    ...
    /**
     * Handle state conflicts (e.g. already has an active subscription, nothing to cancel)
     */
    ...
    /**
     * Handle upstream PayPal API failures (Subscriptions/Catalog Products/webhook verify)
     */
