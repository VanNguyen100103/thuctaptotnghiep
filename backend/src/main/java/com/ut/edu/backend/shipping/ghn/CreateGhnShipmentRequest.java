...
public record CreateGhnShipmentRequest(
        ...
        String note,
        /** Package dimensions in cm - optional, POS "Bán giao hàng" panel sends these (defaults there: 10x10x10); null falls back to GhnShipmentService's own defaults for callers (like the "Tạo đơn test" modal) that don't expose them. */
