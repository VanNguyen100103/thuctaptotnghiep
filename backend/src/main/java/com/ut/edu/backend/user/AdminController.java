...
/**
 * Platform User Management (SaaS operator)
 * Restricted to SUPER_ADMIN - manages ALL users across every store.
 * Store owners manage their own staff via /store/** endpoints (Phase 2).
 */
@RestController
